...
If you want to experiment with the code yourself, feel free to clone the repository and install the package with the -e flag. To help with debugging, set debug to tru in the omero config once the plugin is installed:
